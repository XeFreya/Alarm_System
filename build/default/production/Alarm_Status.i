...
void alarm_disarmed(void) {
    ...
    char buffer_temp[16];
    sprintf(buffer_temp, "Temp: %d C   ", temperatura);
...
void mostrar_zona_alarma(void) {
    ...
    switch (g_zona_alarma) {
        case 1: LCD_SendString("P. PRINCIPAL"); break;
        case 2: LCD_SendString("P. TRASERA"); break;
        case 3: LCD_SendString("VENTANA 1"); break;
        case 4: LCD_SendString("VENTANA 2"); break;
        case 5: LCD_SendString("VENTANA 3"); break;
        case 6: LCD_SendString("VENTANA 4"); break;
