...
# 9 "lcd_i2c.c" 2
# 41 "lcd_i2c.c"
static uint8_t _backlight_state = 0b00001000;
...
static void LCD_SendNibble(uint8_t nibble, uint8_t isData) {
    ...
    byte_to_send = (nibble & 0xF0) | (isData ? 0b00000001 : 0) | _backlight_state;


    LCD_SendByteI2C(byte_to_send | 0b00000100);
